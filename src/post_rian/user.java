...
public class user extends javax.swing.JFrame {
    ...
    private void tampilData() {
        try {
            Object[] judul_kolom = {"ID", "Username", "Name", "Password", "Email"};
            ...
            while (RsSakit.next()) {
                Object[] data = {
                    ...
                    RsSakit.getString("username"),
                    RsSakit.getString("NAME"),
                    RsSakit.getString("PASSWORD"),
                    RsSakit.getString("email"),};
...
//        jTextFieldPlafon.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jLabelDiagnosa.setText("Password");
        ...
        jLabelHasil.setText("Nama");
        getContentPane().add(jLabelHasil, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 170, -1, -1));

        jLabelUmur.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabelUmur.setText("Email");
        getContentPane().add(jLabelUmur, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 220, -1, -1));
        ...
        getContentPane().add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 150, 266, -1));
        getContentPane().add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 200, 266, -1));

        nama.setText(" ");
        getContentPane().add(nama, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 170, 266, -1));
        ...
        TableRs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Username", "Nama", "Email", "Created at"
            }
        ));
        ...
        getContentPane().add(jButtonAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 320, -1, -1));
        ...
        getContentPane().add(jButtonSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 320, -1, -1));
        ...
        getContentPane().add(jButtonDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 320, -1, -1));
        ...
        getContentPane().add(jButtonUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 320, -1, -1));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 260, 940, 970));
        ...
        getContentPane().add(Id, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 120, 180, -1));
        ...
        getContentPane().add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 220, 180, -1));
...
//        String Tanggungan = jComboBoxJentang.getSelectedItem().toString();
        ...
        if (Username.isEmpty()) {
            ...
            try {
                ...
                stt.executeUpdate("INSERT INTO ujian_visual.users(name,username, password)"
